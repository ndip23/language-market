...
import { 
  ...
  UserCheck, Award, Plus, Minus, HelpCircle, Check, Crown
} from 'lucide-react';
...
const Landing = () => {
    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      <section className="pt-32 md:pt-48 pb-20 px-6 relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-center lg:text-left">
          <div className="animate-in fade-in slide-in-from-left duration-1000">
            ...
            <p className="text-lg md:text-xl text-slate-500 font-medium max-w-lg mb-10 leading-relaxed italic mx-auto lg:mx-0">
            ...
            <div className="bg-emerald-50 border border-emerald-100 p-8 rounded-[2.5rem] mb-10 relative overflow-hidden group max-w-lg mx-auto lg:mx-0 text-left">
      ...
      <section className="py-24 md:py-32 bg-slate-50 border-y border-slate-100 px-6">
        <div className="max-w-4xl mx-auto text-center mb-20">
          <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter italic mb-6 leading-tight">How We Help Teachers <br/> <span className="text-emerald-600">Get Students</span></h2>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-10 md:p-14 rounded-[3.5rem] border border-slate-100 shadow-sm flex flex-col hover:shadow-2xl transition-all group">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4 italic uppercase tracking-tighter">You Stay Independent</h3>
          ...
          <div className="bg-white p-10 md:p-14 rounded-[3.5rem] border border-slate-100 shadow-sm flex flex-col hover:shadow-2xl transition-all group">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4 italic uppercase tracking-tighter">Keep 100% of Your Earnings</h3>
            <p className="text-slate-500 font-medium leading-relaxed italic">When students contact you, you arrange lessons directly with them. You keep 100% of your earnings. We don't take commissions from your private external lessons.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter italic text-center mb-20 underline decoration-emerald-200 decoration-8 underline-offset-8">What's Included in Your Membership</h2>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter italic mb-16">Tutor Promotion Membership</h2>
      ...
      <section className="py-24 px-6 max-w-4xl mx-auto text-center lg:text-left">
        ...
        <div className="space-y-6 mb-12 flex flex-col items-center lg:items-start">
            {[
                ...
                <div key={i} className="flex items-center space-x-6 group w-full">
                    <div className="w-12 h-12 bg-slate-900 text-white rounded-full flex items-center justify-center font-black italic shadow-lg shrink-0 group-hover:bg-emerald-600 transition-colors">{step.n}</div>
  ...
  <div className="max-w-6xl mx-auto bg-slate-900 rounded-[2.5rem] md:rounded-[4.5rem] p-8 md:p-24 text-center relative overflow-hidden shadow-2xl border-4 border-white/5">
    
    {/* Background Decoration - Scaled for mobile */}
    <div className="absolute top-0 right-0 w-32 h-32 md:w-64 md:h-64 bg-emerald-500/5 rounded-bl-full -z-0"></div>
    <div className="absolute bottom-0 left-0 w-16 h-16 md:w-32 md:h-32 bg-white/5 rounded-tr-full -z-0"></div>

    <div className="relative z-10">
      {/* 🚨 Heading: Adjusted font size and leading for mobile */}
      <h2 className="text-3xl md:text-7xl font-black text-white tracking-tighter italic mb-6 md:mb-10 leading-[1.1]">
        Start Attracting More <br className="hidden md:block" /> Students Today
      </h2>
      ...
      <div className="flex flex-wrap justify-center items-center gap-y-4 gap-x-4 md:gap-x-8 text-emerald-400 font-bold text-[8px] md:text-[10px] uppercase tracking-widest italic opacity-80 px-2">
        
        <div className="flex items-center whitespace-nowrap"><Check size={14} className="mr-1.5" /> Price anchoring</div>
        <div className="hidden md:block text-slate-700 font-normal">|</div>
        
        <div className="flex items-center whitespace-nowrap"><Check size={14} className="mr-1.5" /> Low-risk entry</div>
        <div className="hidden md:block text-slate-700 font-normal">|</div>
        
        <div className="flex items-center whitespace-nowrap"><Check size={14} className="mr-1.5" /> Teacher independence</div>
        <div className="hidden md:block text-slate-700 font-normal">|</div>
        
        <div className="flex items-center whitespace-nowrap"><Check size={14} className="mr-1.5" /> 100% earnings</div>
        <div className="hidden md:block text-slate-700 font-normal">|</div>
        
        <div className="flex items-center whitespace-nowrap"><Check size={14} className="mr-1.5" /> Clear value</div>
      ...
      <section className="py-24 px-6 bg-slate-50 border-t border-slate-100">
        <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-16 tracking-tighter italic text-center underline decoration-emerald-200 decoration-8 underline-offset-8 uppercase">Common Questions.</h2>
            <div className="space-y-4">
                {[
                    { q: "Do I need teaching experience?", a: "No. Many teachers start with little or no online teaching experience. Your unique style and passion matter most." },
                    { q: "Who sets the lesson price?", a: "You decide how much you want to charge your students. 100% of that price belongs to you." },
                    { q: "How do I receive payments from students?", a: "You arrange payment directly with your students using the method you prefer (PayPal, MOMO, Bank)." },
                    { q: "Can I cancel my membership?", a: "Yes. You can cancel anytime before your subscription renews. We believe in total independence for our tutors." }
                ].map((f, i) => (
                    <div key={i} className="bg-white border border-slate-100 p-8 rounded-[2.5rem] shadow-sm">
                        <button onClick={() => toggleFaq(i)} className="w-full flex items-center justify-between text-left focus:outline-none">
                            <span className="font-black text-slate-900 uppercase text-xs tracking-widest italic">{f.q}</span>
                            {activeFaq === i ? <Minus className="text-emerald-500 cursor-pointer"/> : <Plus className="text-slate-300 cursor-pointer"/>}
                        </button>
