      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-slate-900 p-8 rounded-[3rem] text-white shadow-2xl relative border-b-4 border-emerald-500">
            ...
            <p className="text-[8px] text-slate-500 font-bold mt-2 uppercase">
              Gross (Comms + Subs)
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-xl group hover:border-emerald-500 transition-all">
            ...
            <p className="text-slate-400 font-black uppercase text-[9px] tracking-widest mb-1">
            ...
            <p className="text-[8px] text-slate-400 font-bold mt-2 uppercase">
              {stats.activeSubscriptions} Paid Tutors
            </p>
          </div>
              ...
              <thead className="bg-slate-50 border-b border-slate-100 text-slate-400 font-black uppercase text-[9px] tracking-widest">
                <tr>
                  ...
                  <th className="px-6 py-8">
                    {activeTab === 'teachers' ? 'Plan Status' : 'Active Connections'}
                  </th>
                  ...
                  <tr key={u._id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-6 md:px-10 py-8 flex items-center space-x-4">
                      ...
                      <div className="overflow-hidden">
                        <div className="font-black text-slate-900 text-base md:text-lg tracking-tight truncate">
                          {u.name}
                        </div>
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            {u.subscription?.subscribedAt && (
                              <span className="text-[8px] text-slate-400 font-bold">
                                {new Date(u.subscription.subscribedAt).toLocaleDateString()} • {new Date(u.subscription.subscribedAt).toLocaleTimeString()}
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {u.bookedTutors && u.bookedTutors.length > 0 ? (
                            ...
                            u.bookedTutors.map((c, i) => (
                              ...
                              <div
                                key={i}
                                className={`flex flex-col px-3 py-1 rounded-lg border text-[8px] font-black uppercase tracking-tighter ${
                                  c.isPaid
                              ...
                              >
                                ...
                                {c.isPaid && c.paidAt && (
                                  <span className="text-[7px] font-bold text-slate-400">
                                    {new Date(c.paidAt).toLocaleDateString()} • {new Date(c.paidAt).toLocaleTimeString()}
                                  </span>
                                )}
                            ...
                            <span className="text-slate-300 text-[9px] font-bold italic">
                              No active sessions
                            </span>
