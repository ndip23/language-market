        ...
        <div className="fixed inset-0 z-[1000] bg-slate-900/60 backdrop-blur-xl flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-2xl max-h-[85vh] rounded-[3rem] shadow-2xl overflow-hidden flex flex-col animate-in zoom-in duration-300">
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-6">
                    {[
                        { icon: <DollarSign size={16}/>, t: "100% Earnings", c: "Your income belongs to you. You set your own hourly rates." },
                        { icon: <Zap size={16}/>, t: "Visibility Packages", c: "Search priority is determined by your chosen subscription tier." },
                        { icon: <Award size={16}/>, t: "Conduct Code", c: "Punctuality and professional respect are mandatory at all times." },
                        { icon: <AlertTriangle size={16}/>, t: "Zero Poaching", c: "Bypassing the platform results in immediate permanent removal." }
                    ].map((r, i) => (
