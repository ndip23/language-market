...
const { updateTeacherStatus, getPlatformStats, getAllTeachersForAdmin, getAdminUsers, sendBroadcast   } = require('../controllers/adminController');
...
router.post('/broadcast', auth, admin, sendBroadcast);
